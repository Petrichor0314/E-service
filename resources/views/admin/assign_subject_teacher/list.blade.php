                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/assign_subject_teacher/edit/' . $value->id) }}" class="btn btn-primary">Modifier</a>
                                                <a href="{{ url('admin/assign_subject_teacher/edit_single/' . $value->id) }}" class="btn btn-success">Modifier seulement</a>
                                                <a href="{{ url('admin/assign_subject_teacher/delete/' . $value->id) }}" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
